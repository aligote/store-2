...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 17, 2016 at 05:29 AM
...
-- Database: `store_db`
--
CREATE DATABASE IF NOT EXISTS `store_db` DEFAULT CHARACTER SET utf8 COLLATE utf8_bin;
USE `store_db`;
...
(2, 'adidas NMD', '125', 'adidas Originals', 'Mens', 'Running', '2018-02-22'),
(3, 'Nike Rosche', '120', 'Mens Running', 'Mens', 'Running', '2018-02-22'),
(5, 'Converse Originl', '80', 'Converse Originals', 'Mens', 'Casual', '2018-02-22');
