    ...
    while ($row = $res->fetch()) {
        ...
        <div class="col-sm-4 col-lg-4 col-md-4">
            <div class="thumbnail">
                ...
                <div class="caption">
                    <h4 class="pull-right">Price: '.$product_price.'</h4>
    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <div class="list-group">
                <a href="index.php" class="list-group-item">All Shoes</a>
                <a href="index.php?cat=Shirts" class="list-group-item">Men's</a>
                <a href="index.php?cat=Pants" class="list-group-item">Women's</a>
            </div>
        </div>
        <div class="col-md-9">
            <div class="row">
