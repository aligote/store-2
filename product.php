        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="list-group">
                    <a href="#" class="list-group-item active">7</a>
                    <a href="#" class="list-group-item">7.5</a>
                    <a href="#" class="list-group-item">8</a>
					<a href="#" class="list-group-item">8.5</a>
					<a href="#" class="list-group-item">9</a>
					<a href="#" class="list-group-item">9.5</a>
            ...
            <div class="col-md-9">
                ...
                <div class="caption-full">
                    <h3 class="pull-right">Price: <?php echo $product_price;?></h3>
